    ...
    <div className="max-w-[1200px] max-h-[400px] mx-auto relative top-40 
     max-lg:mt-[650px]  ">
      ...
      flex justify-between items-center  ">
        ...
        <div className="bg-blue-600 rounded-ss-full  px-20 max-lg:px-10  py-28 relative max-md:hidden">
          <div className="flex justify-center items-center relative top-4 -left-28  
