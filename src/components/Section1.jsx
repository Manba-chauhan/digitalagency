    ...
    <div className="w-full">
      ...
      max-sm:justify-center items-center">
        <div className="relative pl-20  max-md:left-0 lg:left-0 max-sm:pl-0">
          <div
            className="bg-white shadow-sm  max-w-[471px] max-md:max-w-[360px]  
            relative   top-20   z-50 px-1 py-4
        ...
        <div className="flex relative right-0  z-50">
          <div className="">
            ...
            max-lg:w-[400px] max-lg:mx-auto max-sm:w-[300px]">
              ...
              <div className="absolute right-20 -z-50 max-xl:right-0 max-lg:right-0 max-sm:right-0">
